...
})(
	{
		...
		11: [
			function (t, e, n) {
				...
				var l = t("<? php base_url('')?>lib/helper"),
					i = t("<? php base_url('')?>lib/dom"),
					s = t("../instances"),
					a = t("../update-geometry"),
					c = t("../update-scroll");
				e.exports = function (t) {
			...
			{
				"<? php base_url('')?>lib/dom": 3,
				"<? php base_url('')?>lib/helper": 6,
				"../instances": 18,
				"../update-geometry": 19,
				"../update-scroll": 20,
			},
		...
		12: [
			function (t, e, n) {
				...
				var o = t("<? php base_url('')?>lib/helper"),
					l = t("<? php base_url('')?>lib/dom"),
					i = t("../instances"),
					s = t("../update-geometry"),
					a = t("../update-scroll");
				e.exports = function (t) {
